...
#new_model_name = "phi-3-128k-finetuned-15000-dataset" # phi
new_model_name = "llama-2-7b-finetuned-15000-dataset" # lama
...
def load_dataset_custom():
    ...
    train_data = load_dataset("LisaSchunke/finetuning_dataset_TSAC", split="train[0:15000]",token=True)
    test_data = load_dataset("LisaSchunke/finetuning_dataset_TSAC", split="test[0:3750]",token=True)
